            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th>ลำดับ</th>
                 ...
                 <td> <a href="form/form-updata-user.php?edit=<?php echo $r["userid"];?>"" ><i class="fa fa-eyedropper"></i></a> </td>
                 <td> <a href="algorithm/delete_user.php?delete=<?php echo $r["userid"]?>" onclick="return confirm('ยืนยันการลบข้อมูล')"><i class="fa fa-trash-o "></i></a> </td>
                  </tr>
                  <?php endforeach;?>
              </table>
            </div>
