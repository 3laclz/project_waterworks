        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">แก้ไขอุปกรณ์</h3>
            </div>
             <!-- /.box-header -->
                <div class="box-body no-padding">
                  <div class="mailbox-read-message">
                   <form action="act_tool/update_tool.php" method="get">
                   <table class="table table-hover table-striped table-bordered">
                      ...
                      <tr> 
                        <td width="10%">
                           ...
                           <input type="text" name="txtkeytool" class="form-control" value="<?php echo $keytool?>">
                           </div>
                        </td>
                        <td width="20%">
                           <div class="form-group">
                           <input type="text" name="txtidtool" class="form-control" value="<?php echo $idtool?>">
                           </div>
                        </td>
                        <td width="50%">
                           <div class="form-group">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                          <a class="btn btn-danger" href="algorithm_tool/delete_tool.php?Num=<?php echo $keytool?>" onclick="if(confirm('ยืนยันการลบข้อมูล  ข้อมูลอุปกรณ์ทั้งหมดจะหายไป')) return true; else return false;">ลบข้อมูลทั้งหมด </a>                                       
