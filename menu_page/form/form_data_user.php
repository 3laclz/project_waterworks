...
<?php
  require '../../connect/connect.php';
  $userid=$_GET['userid'];
  $sql_name = "SELECT * FROM datauser INNER JOIN address ON datauser.userid = address.userid WHERE datauser.userid=$userid";
  $objq_name = mysqli_query($conn, $sql_name);
  $objr_name = mysqli_fetch_array($objq_name);
  
  $villageid = $objr_name['villageid'];
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <p class="text-muted">
                                               บ้านเลขที่ <?php echo $objr_name['address']?>  หมู่ที่ <?php echo $objr_name['villageno']?> ตำบลบ้านถ้ำ                          
              </p>
                  ...
                  <!-- /.user-block -->
                   <div class="post">
                    ...
                    <tr>
                      ...
                      <th class="text-center">ค่ามิเตอร์ก่อนหน้า</th>
                      <th class="text-center">ค่ามิเตอร์หลัง</th>
                     ...
                     <td class="text-center"><?php echo $m["meter"]?></td>
                     <td class="text-center"><?php echo $m["total_meter"]?></td>
