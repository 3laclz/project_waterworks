...
$sql_search_year="SELECT datatime,sum(money),sum(meter) FROM datameter WHERE (datatime between '$year_before-01-01' and '$year_after-12-31') GROUP BY YEAR(datatime)";
$objq_search=mysqli_query($conn,$sql_search_year);
$sql_search_sum="SELECT sum(meter),sum(money) FROM datameter  WHERE (datatime between '$year_before-01-01' and '$year_after-12-31')  ";
            ...
            <div class="tab-content">
              ...
              <div class="box-header">
                <h3 class="box-title">สถิติการใช้น้ำ</h3>
                 ...
                 <tr>
                 <td class="text-center" width ="200"><?php echo $m['datatime']?></td>
              ...
              <table id="example" class="table table-bordered table-striped">
                 ...
                 <tr>
                 <td class="text-center"><?php echo $year_before?> ถึง  <?php echo $year_after?></td>
