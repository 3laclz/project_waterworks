...
$sql_report="SELECT * FROM report WHERE userid='$userid'";
$objq_report=mysqli_query($conn, $sql_report);
?>
<!DOCTYPE html>
<html>
<head>
      ...
      <div class="row">
        ...
        <!-- /.col -->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">จดหมายที่ส่งเเล้ว</h3>
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                 <?php $i=1;?>
                  <?php foreach ($objq_report as $report):?>
                  <?php  
                         $str=$report['form_report'];
                         $cutstr = substr($str,0,100);?>
                  <tr>
                    <td class="mailbox-name"><a href="#" data-toggle="modal" data-target="#<?php echo $i?>"><i class="fa fa-star"></i></a></td>                              
                    <td class="mailbox-subject"><?php echo $cutstr;?></td>
                    <td class="mailbox-date"><?php echo $report['datatime']?></td>
                     <div class="modal fade" id="<?php echo $i?>" role="dialog">
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                              <h2 class="fa fa-minus-square modal-title"> รายงานแจ้งปัญหา</h2>
                            </div>
                            <div class="modal-body col-md-12">
                              <div class="box-body no-padding">
                                 <div class="mailbox-read-info">
                                    
                                    <h5><?php echo $objr_name['name']?>  <?php echo $objr_name['lastname']?>
                                      <span class="mailbox-read-time pull-right">ส่งเมื่อ <?php echo $report['datatime']?></span>
                                      </h5>
                                      <h5> <span class="mailbox-read-time pull-right">ถึง อบต.</span></h5><br>
                                      
                                  </div>
                                 
                                  <!-- /.mailbox-controls -->
                                  <div style="height: 300px" class="mailbox-read-message">
                                    <p><?php echo $report['form_report']?></p>
                                  </div>
