  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.col -->
        <form action="algorithm/send_report.php" method="post">
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">ส่งข้อความแจ้งปัญหา</h3>
                </div>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                            <textarea name="txtreport" id="compose-textarea"  class="form-control" style="height: 300px"></textarea>
                    </div>
                      <div class="form-group">
                        <div class="btn btn-default btn-file">
                          <i class="fa fa-paperclip"></i> แนบรูปภาพ
