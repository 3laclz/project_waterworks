...
$sql_meter="SELECT * FROM datameter WHERE villageid='$villageid'";
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">ข้อมุลใช้น้ำรายเดือน</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                  ...
                  <td>
                     <?php
                            ...
                            $source = new DateTime($source);
                             require_once 'algorithm/datetime_month.php';
                            $strDate = $source->format('M-Y');
                            echo DateThai($meter['datatime'])
                     ?>
                  </td>
                  <td><?php echo $meter['total_meter']-$meter['meter']?></td>
                  <td><?php echo $meter['total_meter']?></td>
                  <td><?php echo $meter['meter']?></td>
                  <td><?php echo $meter['money']?></td>
                  <td></td>
                </tr>
                <?php endforeach;?>
              </table>
